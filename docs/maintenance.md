...
Current check inventory: No CI workflow exists yet. Add Markdown and link validation before configuring their emitted job names as required checks. Unit coverage does not apply to this repository.
...
TODO: complete the scoped acceptance criteria in the [engineering follow-up](https://github.com/marinasofia/marinasofia/issues/1).
